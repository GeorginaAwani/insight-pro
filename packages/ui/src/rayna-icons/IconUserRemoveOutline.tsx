...
const SvgIconUserRemoveOutline = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width="1em"
    height="1em"
    viewBox="0 0 24 24"
    ...
    <path
      ...
      fill="currentColor"
    />
    <path d="M18 4a1 1 0 1 0 0 2h4a1 1 0 1 0 0-2h-4Z" fill="currentColor" />
  </svg>
)
const Memo = memo(SvgIconUserRemoveOutline)
export default Memo
