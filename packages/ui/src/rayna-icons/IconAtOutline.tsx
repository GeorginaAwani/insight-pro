...
const SvgIconAtOutline = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width="1em"
    height="1em"
    viewBox="0 0 24 24"
    ...
    {...props}>
    <g clipPath="url(#icon-at-outline_svg__a)">
      <path
    ...
    <defs>
      <clipPath id="icon-at-outline_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
)
const Memo = memo(SvgIconAtOutline)
export default Memo
