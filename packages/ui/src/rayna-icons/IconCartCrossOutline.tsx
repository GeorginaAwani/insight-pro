...
const SvgIconCartCrossOutline = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width="1em"
    height="1em"
    viewBox="0 0 24 24"
    ...
    />
    <path
      d="M9.25 22a1.25 1.25 0 1 0 0-2.5 1.25 1.25 0 0 0 0 2.5ZM19.5 20.75a1.25 1.25 0 1 1-2.5 0 1.25 1.25 0 0 1 2.5 0ZM18.707 2.293a1 1 0 1 0-1.414 1.414l.707.707-.707.707a1 1 0 0 0 1.414 1.415l.707-.708.707.708a1 1 0 1 0 1.415-1.415l-.708-.707.707-.707a1 1 0 1 0-1.414-1.414L19.414 3l-.707-.707Z"
      fill="currentColor"
    />
  </svg>
)
const Memo = memo(SvgIconCartCrossOutline)
export default Memo
