...
const SvgIconCallOutgoingFilled = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width="1em"
    height="1em"
    viewBox="0 0 24 24"
    ...
    />
    <path
      d="M19.269 5.673a1 1 0 0 0-.94-.94l-2.003-.117a1 1 0 0 0-.318 1.964l-1.98 1.98a1 1 0 0 0 1.414 1.415l1.98-1.98a1 1 0 0 0 1.965-.318l-.118-2.004Z"
      fill="currentColor"
    />
  </svg>
)
const Memo = memo(SvgIconCallOutgoingFilled)
export default Memo
